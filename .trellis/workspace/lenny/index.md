...
|---|------|-------|---------|--------|
| 26 | 2026-09-17 | dev/prod 环境隔离 | `02ff43f`, `8db7b68` | `main` |
...
| 15 | 2026-09-15 | 详情页 AI 悬浮入口（收起/气泡双态） | `e173f1e`, `b8636d3` | `main` |
...
| 8 | 2026-09-13 | Light theme reachable: persisted app-bar theme toggle | `3d1dd8d` | `main` |
